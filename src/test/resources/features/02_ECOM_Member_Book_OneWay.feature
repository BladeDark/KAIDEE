...
@Normal_User
@Oneway
Scenario Outline: Member Book with One Way 
	...
	Examples: 
		...
		|  	Oneway		|		KRP	      	|			CPH 	    	|     	3 	  		|  		3		|		3		|		CASH					|
		|	OneWay		|		KRP			|			CPH				|		3			|		3		|		0		|		DIBS					|
		|	OneWay		|		KRP			|			CPH				|		3			|		3		|		0		|		Emerchantpay			|

@Normal_User
@Oneway
@Package
Scenario Outline: Member Book one way with package 
	When I select "<TravelType>" for travel type 
	And I select "<OriginAirport>" on origin airport 
	And I select "<DestinationAirport>" on destination airport 
	And I select available departure date 
...
@Oneway
@Extras
Scenario Outline: Member Book one way with extras
	When I select "<TravelType>" for travel type 
	And I select "<OriginAirport>" on origin airport 
	And I select "<DestinationAirport>" on destination airport 
	And I select available departure date 
...
@Package
@Extras
Scenario Outline: Member Book one way with package and extras
	When I select "<TravelType>" for travel type 
	And I select "<OriginAirport>" on origin airport 
	And I select "<DestinationAirport>" on destination airport 
	And I select available departure date 
...
@Oneway
@Package
Scenario Outline: Member Book One way and buy package after
	When I select "<TravelType>" for travel type
	And I select "<OriginAirport>" on origin airport 
	And I select "<DestinationAirport>" on destination airport 
	And I select available departure date 
...
@Oneway
@Extras
Scenario Outline: Member Book One way and buy extras after
	When I select "<TravelType>" for travel type
	And I select "<OriginAirport>" on origin airport 
	And I select "<DestinationAirport>" on destination airport 
	And I select available departure date 
...
@Package
@Extras
Scenario Outline: Member Book One way and buy package and extras after
	When I select "<TravelType>" for travel type
	And I select "<OriginAirport>" on origin airport 
	And I select "<DestinationAirport>" on destination airport 
	And I select available departure date 
...
@Oneway
@Namechange
Scenario Outline: Member Book One way and change name
	When I select "<TravelType>" for travel type
	And I select "<OriginAirport>" on origin airport 
	And I select "<DestinationAirport>" on destination airport 
	And I select available departure date 
	...
	Examples: 
		| TravelType	|	OriginAirport 	|  	DestinationAirport 		| 	No_Adult 	  	|	No_Child	|	No_Infant	| 	Payment_Method 				|	
		|	OneWay		|		KRP			|			CPH				|		1			|		1		|		1		|		Cash					|	
		|	OneWay		|		KRP			|			CPH				|		1			|		1		|		1		|		DIBS					|
		|	OneWay		|		KRP			|			CPH				|		1			|		1		|		1		|		Emerchantpay			|
		
@Normal_User		
@Oneway
@Rebook
Scenario Outline: Member user Book One way and rebook outbound segment
	When I select "<TravelType>" for travel type
	And I select "<OriginAirport>" on origin airport 
	And I select "<DestinationAirport>" on destination airport 
	And I select available departure date 
