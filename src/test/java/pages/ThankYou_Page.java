...
public class ThankYou_Page extends PageObject {
	...
	public void get_Record_Locator(){
		WebElementFacade element = find(By.xpath(".//div[@class='confirmation grid12-9 no-left-gutter']/h3"));
	...
	public void click_Manage_Booking(){
		WebElementFacade element = find(By.xpath("//span[text()='Manage booking']"));
		element.click();
	}
